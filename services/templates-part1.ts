...
<style>
  ...
  body { font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; color:#111827; padding: 15mm; }
...
<style>
  ...
  body { font-family: Inter, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Arial, sans-serif; padding: 15mm; }
...
<style>
  ...
  body { font-family: 'Merriweather', Georgia, serif; padding: 15mm; }
...
<style>
  ...
  .grid { display:grid; grid-template-columns: 70mm 1fr; width: 100%; height: 100%; }
  .left { background:#0b1020; color:white; padding:15mm; }
  .right { padding:15mm; }
...
<style>
  ...
  .container { width: 100%; height: 100%; display:grid; grid-template-columns: 1fr 1fr; gap:16px; }
...
<style>
  ...
  .content { padding:20px; width: 100%; height: calc(100% - 70px); }
  .section { margin-top:20px; }
  ...
  ul { margin:6px 0 0 16px; padding:0; }
  li { font-size:12px; margin-bottom:4px; }
  .chip { background:#fff0f3; color:#be123c; padding:4px 8px; border-radius:999px; font-size:11px; display:inline-block; margin:0 6px 6px 0; }
</style>
</head>
<body>
  <div class="header">
...
<style>
  ...
  body { background:var(--bg); color:var(--fg); font-family:'Orbitron', sans-serif; padding: 15mm; }
  .container { width: 100%; height: 100%; }
...
<style>
  ...
  .content { width: 100%; height: calc(100% - 100px); padding:20px; }
  .section { margin-top:20px; }
...
<style>
  ...
  body { font-family: Quicksand, sans-serif; background:var(--bg); padding: 15mm; }
  .container { background:white; padding:20px; width: 100%; height: 100%; border-radius:12px; }
